...
import com.app.utils.VoterException;
...
public class UserDaoImpl implements UserDao {
	...
	@Override
	public String voterRegistration(User newVoter) throws SQLException, VoterException {
		// 1. set IN params
		/*
		 * int userId, String firstName, String lastName, String email, String password,
		 * Date dob, boolean status, String role
		 */
		LocalDate d1=newVoter.getDob().toLocalDate();
